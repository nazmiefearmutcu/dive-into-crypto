...
val PRESETS: List<DivePreset> = listOf(
    ...
    // ── TERMINAL · "Depth Terminal" (anti-slop instrument palette) ────────
    // Light-gray ink + a single phosphor accent (not green-on-green): dense,
    // readable, schematic. Mirrors the desktop Depth Terminal exactly.
    DivePreset("term-phosphor", "TERMINAL", "Phosphor", dark = true, radiusDp = 2, mono = true,
        bg = rgb(0x05070A), bg2 = rgb(0x080B10),
        elev = rgb(0x0A0E14), elev2 = rgb(0x0C1119),
        border = rgb(0x182029), borderStrong = rgb(0x232E38),
        text = rgb(0xDFE7EA), muted = rgb(0x7C8A92), dim = rgb(0x3A454D),
        accent = rgb(0x39FF9E), accent2 = rgb(0x1C7A52),
        up = rgb(0x4DFFA6), down = rgb(0xFF5C6C), warn = rgb(0xFFC23D)),
    DivePreset("term-amber", "TERMINAL", "Amber", dark = true, radiusDp = 2, mono = true,
        bg = rgb(0x0A0602), bg2 = rgb(0x0D0803),
        elev = rgb(0x100A03), elev2 = rgb(0x140D04),
        border = rgb(0x241A0D), borderStrong = rgb(0x332512),
        text = rgb(0xF3E2C4), muted = rgb(0x9A8560), dim = rgb(0x4A3C26),
        accent = rgb(0xFFB02E), accent2 = rgb(0x7A5410),
        up = rgb(0xFFD166), down = rgb(0xFF6B4A), warn = rgb(0xFFD93D)),
    DivePreset("term-ice", "TERMINAL", "Ice", dark = true, radiusDp = 2, mono = true,
        bg = rgb(0x04070C), bg2 = rgb(0x060A11),
        elev = rgb(0x080D16), elev2 = rgb(0x0A1220),
        border = rgb(0x131F2C), borderStrong = rgb(0x1E2F40),
        text = rgb(0xD8E6F2), muted = rgb(0x6F8399), dim = rgb(0x33424F),
        accent = rgb(0x59C6FF), accent2 = rgb(0x1A6A99),
        up = rgb(0x5FE0E0), down = rgb(0xFF6B8A), warn = rgb(0xFFCF5C)),
    DivePreset("term-paper", "TERMINAL", "Paper", dark = false, radiusDp = 2, mono = true,
        bg = rgb(0xE9E4D8), bg2 = rgb(0xE4DED0),
        elev = rgb(0xF2EEE4), elev2 = rgb(0xECE7DA),
        border = rgb(0xCFC8B6), borderStrong = rgb(0xBCB4A0),
        text = rgb(0x1B1C18), muted = rgb(0x6B675B), dim = rgb(0xB3AD9C),
        accent = rgb(0xC2410C), accent2 = rgb(0xE08A5A),
        up = rgb(0x1A7A4A), down = rgb(0xB42318), warn = rgb(0xA66A00)),
)

const val DEFAULT_PRESET = "term-phosphor"
